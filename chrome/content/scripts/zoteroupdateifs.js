...
// 得到JCR分区
  ...
  Zotero.UpdateIFs.NJAU_Core = function(item){
    ...
    if (classOne.includes(pubT)) { return '一类核心';
        } else if (classTwo.includes(pubT)) {return '二类核心';
        } else {
        return '无'
        }
  ...
  Zotero.UpdateIFs.NJAU_High_Quality = function(item){
    ...
    if (highQulityOne.includes(pubT)) { return '自然科学一类'; // 高质量论文一类
        } else if (highQulityTwo.includes(pubT)) {return '自然科学二类'; // 高质量论文二类
        } else if (highQulityA.includes(pubT)) {return '自然科学A';
        } else if (highQulityB.includes(pubT)) {return '自然科学B';
        } else if (highQulityC.includes(pubT)) {return '自然科学C';
        } else {
        return '无'
        }
